...
3 & 00.00 & 0000& 000000& 000000& 000000 \\ \hline % Need to fill in this line!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
\subsection{Changing Joint Angle Ranges} %Are these singularities

Another possible method to reduce the Cartesian error is to either remove the troublesome regions identified in Section \ref{sec:spread} or possibly, where they present a boundary to the region, extend the region beyond them in the hopes that performing training either side will reduce the overall error. %grr not written well
